...
let package = Package(
        name: "AlibabacloudDysmsapi20170525",
        ...
        products: [
            .library(
                    name: "AlibabacloudDysmsapi20170525",
                    targets: ["AlibabacloudDysmsapi20170525"])
        ],
        dependencies: [
            ...
            .package(url: "https://github.com/lz990377023/darabonba-openapi.git", from: "1.0.8"),
            .package(url: "https://github.com/lz990377023/openapi-util.git", from: "1.0.2"),
